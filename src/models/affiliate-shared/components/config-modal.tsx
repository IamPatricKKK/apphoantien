      ...
      footer={
        <div className="flex flex-wrap gap-3">
          <button
            type="button"
            onClick={onClose}
            className="rounded-[18px] border border-[#f5cfe2] bg-white px-7 py-4 text-lg font-bold text-slate-500"
          >
            Dong
          </button>
          <button
            ...
            form="save-curl-form"
            disabled={savingCurl}
            className="rounded-[18px] bg-[#ff6bb5] px-7 py-4 text-lg font-bold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
          >
    ...
    >
      <form id="save-curl-form" onSubmit={onSubmit}>
        ...
        <textarea
          ...
          className="min-h-[260px] w-full rounded-[24px] border border-[#f5cfe2] bg-[#fffafd] px-5 py-4 font-mono text-sm leading-7 text-slate-700 outline-none transition focus:border-[#ff6bb5]"
        />
